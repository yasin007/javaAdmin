package com.yangyi.resume.monitor.service.impl;

import cn.hutool.json.JSONObject;
import cn.hutool.json.JSONUtil;
import com.yangyi.resume.common.utils.IpUtil;
...
import com.yangyi.resume.monitor.repository.LoggingRepository;
import com.yangyi.resume.monitor.service.LoggingService;
...
public class LoggingServiceImpl implements LoggingService {
    ...
    public void save(ProceedingJoinPoint joinPoint, Logging logging){
        ...
        com.yangyi.resume.common.aop.log.Log log = method.getAnnotation(com.yangyi.resume.common.aop.log.Log.class);
