...
import com.yangyi.resume.monitor.domain.LogMessage;
            ...
            public void run() {
                while (true) {
                    try {
                        ...
                        if (log != null) {
                            // 格式化异常堆栈信息
                            if ("ERROR".equals(log.getLevel()) && "com.yangyi.resume.common.exception.handler.GlobalExceptionHandler".equals(log.getClassName())) {
